...
public class DashParticleData implements IParticleData {
	...
	public static final IDeserializer<DashParticleData> DESERIALIZER = new IDeserializer<DashParticleData>() {
		@NotNull @Override
		public DashParticleData deserialize(
		...
		@Override
		public @NotNull DashParticleData read(
		  @NotNull ParticleType<DashParticleData> type, @NotNull PacketBuffer buf
		) {
	...
	public static class DashParticleType extends ParticleType<DashParticleData> {
		...
		@NotNull @Override public Codec<DashParticleData> func_230522_e_() {
			return CODEC;
		}
	}
}
